  ...
  return (
    <>
      <div className="home-title">
        <span style={{ color: theme.colors.color }} className="title-covid-19">
          Covid-19
        </span>
        <span style={{ color: theme.colors.color }} className="title-onWorld">
          On World
        </span>
        <Switch
          onChange={() => {
